            ...
            <div class="col-md-3 filter-sidebar p-4">
                ...
                <div class="mb-3">
                    ...
                    <select id="yearMin" class="form-select">
                        <option selected="selected" value="0">Year minimum</option>
                    </select>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select id="yearMax" class="form-select">
                        <option selected="selected" value="0">Year maximum</option>
                    </select>
                </div>
        ...
        function processCarData (data) {
            ...
            let currentPage = 1;
                ...
                function filterCars() {
                    ...
                    const car_price = document.getElementById('price-filter').value;
                    ...
                    filteredCars = carData.filter(car => {
                        return (!maker || car.maker.toLowerCase().includes(maker)) &&
                            ...
                            (!car_price || car.car_price <= car_price) &&
                ...
                document.getElementById('yearMin').addEventListener('change', function () {
                    ...
                    const maxYear = parseInt(document.getElementById('yearMax').value) || Infinity; // Default to Infinity if not selected
                ...
                document.getElementById('yearMax').addEventListener('change', function () {
                    ...
                    const minYear = parseInt(document.getElementById('yearMin').value) || 0; // Default to 0 if not selected
                ...
                document.getElementById('search-bar').addEventListener('input', function() {
                    ...
                    filteredCars = carData.filter(car => {
                        ...
                        const matchesPrice = selectedPriceMax ? car.car_price <= selectedPriceMax : true; // Max price condition
